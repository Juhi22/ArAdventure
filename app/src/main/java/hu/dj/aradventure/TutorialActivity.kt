...
class TutorialActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val items = listOf(
            ...
            PageItem(
                R.drawable.tutorial_basic_icons, "A képernyőn ezek az ikonok mindig veled lesznek az úton.\n" +
            ...
            PageItem(
                R.drawable.tutorial_additional_icons,
                "Vannak más ikonok is amik csak bizonyos helyezetben jelennek meg a képernyő tetején.\n" +
            ...
            PageItem(
                R.drawable.tutorial_item_pick_up, "Megjelenhetnek ikonok és szövegek az alábbi elrendezésben.\n" +
            ...
            PageItem(
                R.drawable.tutorial_real_life_photos, "Hol is vannak a völgy lényei? Hogyan jelennek meg?\n" +
                        "Mutass a kamerával a képekre és a képen lévő karakter egyből megelevenedik."
            ),
            PageItem(
                R.drawable.tutorial_conversation, "Találkozhatsz barátságos és ellenséges lényekkel is.\n" +
            ...
            PageItem(
                R.drawable.tutorial_conversation_ending,
                "A párbeszéd során, abban az esetben ha mínusz jel van a választható válaszok között az azt jelenti, hogy nincs több mondandód és véget ér a beszélgetés.\n" +
                        "Erre is rá kell nyomni, ne felejtsd el!"
            ),
            PageItem(
                R.drawable.tutorial_fight,
                "Ha harcra kerül a sor, támadj az ellenségre nyomva. Addig üsd amíg az életereje el nem fogy.\n" +
            ...
            PageItem(
                R.drawable.tutorial_quest,
                "A küldetések teljesítéséhez hajtsd végre a leírt feladatot, majd jelezd annak aki megbízott téged, hogy sikerrel jártál.\n" +
                        "Számláló mutatja, hogy éppen mennyi van még hátra. Ha már leadható a küldetés a piros jel zöldre vált."
            ),
            PageItem(
                R.drawable.trophy, "Teljesítsd a fő és mellék küldetés szálakat, hogy megszerezd az összes trófeát.\n" +
                        "Összegyűjthető trófeák száma: 3"
            )
        )
